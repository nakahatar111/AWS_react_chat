...
class Message extends Component {
  ...
  async clearNotification(){
    await fetch(`https://ec2-54-159-151-111.compute-1.amazonaws.com:5000/notification/clear?user=${this.props.user}&chat_id=${this.props.chat_id}`)
  ...
  addTimestamp = async (msg) =>{
    ...
    if(!this.props.time_stamp){
      await fetch(`https://ec2-54-159-151-111.compute-1.amazonaws.com:5000/message/add?id=0&sender=-1&msg=${time}&chat_id=${this.props.chat_id}`)
      .catch(err => console.error(err))
    }
    else{
  ...
  addMessages = async (msg) =>{
    ...
    await fetch(`https://ec2-54-159-151-111.compute-1.amazonaws.com:5000/message/add?id=0&sender=${this.props.user}&msg=${this.state.msg}&chat_id=${this.props.chat_id}`)
  ...
  getMessages = async _ =>{
    await fetch(`https://ec2-54-159-151-111.compute-1.amazonaws.com:5000/message/get?chat_id=${this.props.chat_id}`)
  ...
  async updateNotifiaction(){
    await fetch(`https://ec2-54-159-151-111.compute-1.amazonaws.com:5000/notification/update?user=${this.props.user}&chat_id=${this.props.chat_id}`)
    .catch(err => console.error(err))
  }
  ...
  handleDelete= async ()=>{
    ...
    console.log('delete');
    await fetch(`https://ec2-54-159-151-111.compute-1.amazonaws.com:5000/chat/delete?chat_id=${this.props.chat_id}`)
